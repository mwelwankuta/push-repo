...
async function githubReposApi(name) {
...
function gitCommands(repoUrl, originUrl, execOptions) {
    try {
    ...
    console.log(chalk.green(`  Successfully created your repository '${name}'. ${repoUrl}`));
}
